...
QRectF FnmQgraphicsItemPointSource::boundingRect() const
{
...
QPainterPath FnmQgraphicsItemPointSource::shape() const
{
    QPainterPath path;
...
void FnmQgraphicsItemPointSource::paint(QPainter *painter, const QStyleOptionGraphicsItem *option, QWidget *widget)
{
    if(isSelected()){
        QPen pen(Qt::black);
        pen.setWidth(1);
...
QVariant FnmQgraphicsItemPointSource::itemChange(QGraphicsItem::GraphicsItemChange change, const QVariant &value)
{
...
void FnmQgraphicsItemPointSource::hoverEnterEvent(QGraphicsSceneHoverEvent *event)
{
