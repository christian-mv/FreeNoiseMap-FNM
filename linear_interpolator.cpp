...
#include <algorithm>
#include <cmath> // this is neeeded for std::abs()
#include <stdexcept>
#include <QtDebug>

Linear_Interpolator::Linear_Interpolator(const std::vector<std::pair<double, double>>& points)
    : _points(points) {
...
double Linear_Interpolator::findValue(double x) const {
