...
public:
    GridSettings();
    explicit GridSettings(Rect rect);

    void setRect(const Rect &newRect){ this->rectGrid = newRect; }
    ...
    Rect getRect() const { return this->rectGrid; }
...
private:
    Rect rectGrid; //represent the extension of the coordinate system
    double dx, dy;
