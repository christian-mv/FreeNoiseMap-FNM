...
void AbstractPolyLine::addSegment(fnm_core::Segment *segment)
{
...
QVector<fnm_core::Segment*> *AbstractPolyLine::getSegments()
{
...
void AbstractPolyLine::updateBoundingRectangle(fnm_core::Segment *newSegment)
{
    double temp;
