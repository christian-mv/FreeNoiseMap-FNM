...
FnmAbstractPolyLineGraphicsItem::FnmAbstractPolyLineGraphicsItem():
...
QRectF FnmAbstractPolyLineGraphicsItem::boundingRect() const
{
...
void FnmAbstractPolyLineGraphicsItem::paint(QPainter *painter,
...
QPainterPath FnmAbstractPolyLineGraphicsItem::shape() const
{
    /*
...
void FnmAbstractPolyLineGraphicsItem::addSegment(Fnm3DSegment *segment)
{
...
QVector<Fnm3DSegment*> *FnmAbstractPolyLineGraphicsItem::getSegments()
{
    return lineSegmentsList;
}

void FnmAbstractPolyLineGraphicsItem::setBufferDistance(const double &newValue)
{
...
void FnmAbstractPolyLineGraphicsItem::updateBoundingRectangle(Fnm3DSegment *newSegment)
{
    double temp;
...
QPainterPath FnmAbstractPolyLineGraphicsItem::singleLineBuffer(QLineF line, const double &distance)
{
    QPainterPath temp;
    temp.moveTo(line.p1());
    temp.lineTo(line.p2());
...
void FnmAbstractPolyLineGraphicsItem::updateMultilineBuffer(QPainterPath newLineBuffer)
{
    multilineBuffer = multilineBuffer.united(newLineBuffer);
}

QVariant FnmAbstractPolyLineGraphicsItem::itemChange(QGraphicsItem::GraphicsItemChange change, const QVariant &value)
{
