...
FnmMultilineGraphicsItem::FnmMultilineGraphicsItem():
    ...
    lineSources(new QVector<Fnm3DSegment*>)
{
...
void FnmMultilineGraphicsItem::addLineSource(Fnm3DSegment *newSource)
{
...
void FnmMultilineGraphicsItem::addLineSource(const QLineF &line)
{
...
QVector<Fnm3DSegment*> *FnmMultilineGraphicsItem::getLineSources()
{
    return lineSources;
}
...
void FnmMultilineGraphicsItem::updateBoundingRectangle(Fnm3DSegment *newSource)
{
    double temp;
